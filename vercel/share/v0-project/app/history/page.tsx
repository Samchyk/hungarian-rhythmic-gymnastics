          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-16">
              ...
              <div className="border-2 border-primary p-8 rounded-lg">
                ...
                <p className="text-foreground/70 mb-4 leading-relaxed">
                  Ebben a periódusban a magyar ritmikus gimnasztika a nemzetközi versen legmagasabb szintjére érkezet. A szövetség megalakulása után a szervezettebb képzési rendszer vezetett az első világversenyi érmekhez.
                </p>
                <p className="text-foreground/70 leading-relaxed">
