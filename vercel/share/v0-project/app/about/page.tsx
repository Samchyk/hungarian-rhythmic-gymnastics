      ...
      <div className="pt-24">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="bg-soft-blush p-8 rounded-lg">
              ...
              {submitted && (
                <div className="mt-4 p-4 bg-primary/20 border border-primary text-primary rounded-lg">
                  Köszönjük az üzenetét! Hamarosan kapcsolatba lépünk Önnel.
                </div>
              )}
            </form>
          </div>
