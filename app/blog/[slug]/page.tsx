...
const articles: Record<string, any> = {
  'flexibility-techniques': {
    ...
    content: `
      ...
      2. Dinamikus nyújtások — lendületes, kontrollált mozgásokkal melegítjük be az izmokat, például lábemelésekkel, karkörzésekkel és csípőrotációkkal. Edzés előtt ajánlott.
  ...
  'beginner-guide': {
    ...
    content: `
      ...
      1. Túl idős vagyok? Hobbi szinten szinte minden korban el lehet kezdeni — a felnőtt csoportok egyre népszerűbbek.
      ...
      7. Magántanár vagy klub? Kezdőknek a klub csoportos formája a jobb — közösség és motiváció szempontjából egyaránt.
